      ...
      <div className="ai-intel-grid-top">
        ...
        <div className="ai-intel-card">
          ...
          <div style={{ marginTop: 24, paddingTop: 20, borderTop: '1px solid rgba(255,255,255,0.08)' }}>
            <h4 style={{ fontSize: 13, fontWeight: 700, color: 'var(--text-secondary)', marginBottom: 12, display: 'flex', alignItems: 'center', gap: 6 }}>
              <FaChartLine style={{ color: '#22d3ee' }} /> Cumulative Outflow Volume
            </h4>
            <div style={{ width: '100%', height: 180 }}>
              <ResponsiveContainer>
                <AreaChart data={compositeChartData}>
                  <defs>
                  ...
                  />
                  <Area type="monotone" dataKey="Historical" stroke="#818cf8" fillOpacity={1} fill="url(#areaGradient)" strokeWidth={2} name="Volume" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </div>
